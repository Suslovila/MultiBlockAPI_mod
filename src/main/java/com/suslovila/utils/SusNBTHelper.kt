...
//Make nbt name unique.
//This should help with nbt name conflicts. For example, you can make an instance of this class for your mod and pass modid as prefix. This will save you from problems
class NbtKeyNameHelper(val prefix: String) {
    fun doAndGet(nbtKeyName: String): String {
        return prefix + "_" + nbtKeyName
    }
}