...
//   }
   ...
   public SusVec3(Number p_82484_, Number p_82485_, Number p_82486_) {
      this.x = p_82484_.doubleValue();
      this.y = p_82485_.doubleValue();
      this.z = p_82486_.doubleValue();
   }
...
//   }
   ...
   public SusVec3 xRot(float angle) {
   ...
   public SusVec3 yRot(float angle) {
      double f = Math.cos(angle);
      double f1 = Math.sin(angle);
   ...
   public SusVec3 zRot(float angle) {
...
//   }
   ...
   public static SusVec3 fromIntArray(int[] array) throws Exception {
      if(array.length != 3) throw new Exception("array length should be 3");
