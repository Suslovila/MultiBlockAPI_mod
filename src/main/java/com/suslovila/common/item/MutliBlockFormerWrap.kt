...
import com.suslovila.utils.SerialiseType
...
object MultiBlockWrapper {
    ...
    val MODE_NAME = ExampleMod.prefixAppender.doAndGet("mode")
    val FIRST_BOUND_NAME = ExampleMod.prefixAppender.doAndGet("firstBound")
    val SECOND_BOUND_NAME = ExampleMod.prefixAppender.doAndGet("secondBound")
    val FILE_NAME = ExampleMod.prefixAppender.doAndGet("file_name")
    val MASTER_BLOCK_POS = ExampleMod.prefixAppender.doAndGet("master_block_pos")

    const val TAG_COMPOUND = 10

    val MODIFIERS_NAME = ExampleMod.prefixAppender.doAndGet("global_modifiers")
    val BLOCK_MODIFIERS_NAME = ExampleMod.prefixAppender.doAndGet("single_modifiers")
...
class Modifier(
    ...
    companion object {
        val VALUE_KEY = ExampleMod.prefixAppender.doAndGet("modifier_value")
        val NAME_KEY = ExampleMod.prefixAppender.doAndGet("modifier_name")
        val TYPE_KEY = ExampleMod.prefixAppender.doAndGet("modifier_type")
