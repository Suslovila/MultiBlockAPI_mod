...
import com.suslovila.common.item.Modifier
...
import com.suslovila.common.sync.PacketBlockModifiers
import com.suslovila.common.sync.PacketHandler
import com.suslovila.common.sync.PacketSetGlobalModifiers
...
import com.suslovila.utils.collection.nextCycled
...
class GUIPlayerDetector(invPlayer: InventoryPlayer, multiBlockFormer: ItemStack, pos: Vec3) : GuiScreen() {
    ...
    companion object {
        ...
        private val texture = ResourceLocation(ExampleMod.MOD_ID, "textures/gui/PlayerDetector2.png")
